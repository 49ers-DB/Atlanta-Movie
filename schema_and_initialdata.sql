...
Values
("georgep","Approved","George P.","Burdell",'111111111'),
('calcwizard','Approved','Issac','Newton','222222222'),
('calcultron','Approved','Dwight','Schrute','333333333'),
('calcultron2','Approved','Jim','Halpert','444444444'),
('gdanger','Declined','Gary','Danger','555555555'),
('imbatman','Approved','Bruce','Wayne','666666666'),
('imready','Approved','Spongebob','Squarepants','777777777'),
('isthisthekrustykrab','Approved','Patrick','Star','888888888'),
('clarinetbeast','Declined','Squidward','Tentacles','999999999'),
('texasStarKarate','Declined','Sandy','Cheeks','111111110'),
('fullMetal','Approved','Edward','Elric','111111100'),
('notFullMetal','Approved','Alphonse','Elric','111111100'),
('ilikemoney$$','Approved','Eugene','Krabs','111111110'),
('eeqmcsquare','Approved','Albert','Einstein','111111110'),
('theScienceGuy','Approved','Bill','Nye','999999999'),
('entropyRox','Approved','Claude','Shannon','999999999'),
('fatherAI','Approved','Alan','Turing','222222222'),
('cool_class4400','Approved','A. TA','Washere','333333333'),
("thePiGuy3.14",'Approved','Archimedes','Syracuse','1111111111'),
('does2Much','Approved','Carl','Gauss','1212121212'),
('programerAAL','Approved','Ada','Lovelace',3131313131),
('radioactivePoRa','Approved','Marie','Curie',1313131313),
('DNAhelix','Approved','Rosalind','Franklin',777777777),
('ghcghc','Approved','Grace','Hopper',666666666),
('RitzLover28','Approved','Abby','Normal',444444444),
('smith_j','Pending','John','Smith',333333333),
('manager1','Approved','Manager',"One",1122112211),
('manager2','Approved','Manager','Two',3131313131),
('manager3','Approved','Three','Three',8787878787),
('manager4','Approved','Four','Four',5755555555);
